...
const minwhaInfo = [
  ...
  {
    subject: "기러기",
    meaning: "기러기는 노후의 안락함을 기원하는 노안도(蘆雁圖)에 등장하며, 가을 경치를 대표합니다",
  ...
  {
    subject: "연꽃",
    meaning: "연꽃은 청렴결백, 부귀영화, 자손 번창을 의미하며, 물고기와 함께 그려지면 풍요로운 생활을 뜻합니다",
    blessing: "연꽃처럼 청렴하고 풍요로운 삶이 되시길 바랍니다"
  },
  {
    subject: "모란",
    meaning: "모란은 '꽃 중의 왕'으로 불리며, 부귀영화를 상징하는 대표적인 소재입니다",
    blessing: "모란처럼 화려하고 영화로운 인생이 되시길 바랍니다"
  },
  {
    subject: "태양과 달",
    meaning: "태양과 달은 음양의 조화를 상징하며, 삶의 균형과 조화를 의미합니다",
    blessing: "태양과 달처럼 조화롭고 균형 잡힌 삶이 되시길 바랍니다"
  },
  {
    subject: "별",
    meaning: "별은 충의로운 사람을 의미하고, 황제의 인자한 마음을 나타내기도 합니다",
    blessing: "별처럼 밝고 인자한 마음으로 모든 일이 순조로우시길 바랍니다"
  },
  {
    subject: "갈대",
    meaning: "갈대는 가을 경치를 나타내고, 노안도에 기러기와 함께 그려져 노후의 안락함을 기원합니다",
